...
feedBtn = tk.Button(gui, text="Feed", width=lWidth, anchor="n", command=feed)
feedBtn.grid(row=5, column=0)
cleanBtn = tk.Button(gui, text="Clean", width=lWidth, anchor="n", command=clean)
cleanBtn.grid(row=5, column=1)
resetBtn = tk.Button(gui, text="Reset", width=lWidth, anchor="n", command=resetprompt)
resetBtn.grid(row=5, column=2)
quitBtn = tk.Button(gui, text="Quit", width=lWidth, anchor="n", command=closeprompt)
